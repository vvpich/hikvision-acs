...
Терминал прикладывает JPEG к событию только если это включено в его
собственных настройках. Управляется через `/ISAPI/AccessControl/AcsCfg`:
...
если загрузка снимков выключена.
